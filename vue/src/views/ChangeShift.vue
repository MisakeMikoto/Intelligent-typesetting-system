<template>
    <div>
        ...
        <div style="padding: 10px 0;">
            <el-input style="width: 200px" placeholder="请输入请求换班用户名称" v-model="searchObj.name"
                      suffix-icon="el-icon-search"></el-input>
            <el-input style="width: 200px" placeholder="请输入被换班用户名称" v-model="searchObj.changedName"
        ...
        <el-table :data="tableData" border stripe
            ...
            <el-table-column prop="changedName" label="被换班员工姓名">
                <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top">
                        <p>被换班员工编号: {{ scope.row.changedUserId }}</p>
