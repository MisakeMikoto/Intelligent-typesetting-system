    ...
    <div>
      ...
      <el-form label-width="100px" v-model="form">
        ...
        <el-form-item label="预计上班天数">
          <el-input v-model="form.workDays" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="实际晚班次数">
          <el-input v-model="form.realEveningShifts" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="预计晚班次数">
          <el-input v-model="form.eveningShifts" autocomplete="off"></el-input>
        </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //保存工作量
            submitSave() {
                workload.saveWorkload(this.form)
                    .then(res => {
                        if (res) {
            ...
            //修改工作量
            submitEdit() {
                workload.editWorkload(this.form)
                    .then(res => {
                        if (res) {
